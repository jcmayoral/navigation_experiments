...
listener.waitForTransform("map_carto", "odom", rospy.Time(0), rospy.Duration(10.0))
old_pose, old_orientation = listener.lookupTransform("map_carto", "odom", rospy.Time(0))
...
while not rospy.is_shutdown():
    listener.waitForTransform("map_carto", "odom", rospy.Time(0), rospy.Duration(1.0))
    p, o = listener.lookupTransform("map_carto", "odom", rospy.Time(0))
...
rospy.loginfo("interventions found %i", tf_corrections)
