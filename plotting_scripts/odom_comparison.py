...
ekf_plot = OdomPlotter(topic_name="/odometry/filtered")
r = 0.3
...
while not rospy.is_shutdown():
    ...
    plt.arrow(x1, y1,r*np.cos(yaw1), r*np.sin(yaw1), color='r')

    plt.scatter(ox, oy, c='b')
    plt.arrow(ox, ox,r*np.cos(oyaw), r*np.sin(oyaw), color='b')
