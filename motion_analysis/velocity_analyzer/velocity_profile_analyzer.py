...
def velocities_cb(odom_msg, cmd_msg):
    ...
    max_error.linear.x = max(diff_twist.linear.x, max_error.linear.x)
    max_error.angular.z = max(diff_twist.angular.z, max_error.angular.z)
...
def cmd_cb(cmd_msg):
    ...
    max_commanded_accel.linear.x = max(diff_twist.linear.x, max_commanded_accel.linear.x)
    max_commanded_accel.angular.z = max(diff_twist.angular.z, max_commanded_accel.angular.z)
...
def odom_cb(odom_msg):
    ...
    max_reported_accel.linear.x = max(diff_twist.linear.x, max_reported_accel.linear.x)
    max_reported_accel.angular.z = max(diff_twist.angular.z, max_reported_accel.angular.z)
